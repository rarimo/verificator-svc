...
type ParametersAttributes struct {
	...
	IdentityCounter           int32   `json:"identityCounter"`
	IdentityCounterLowerBound int32   `json:"identityCounterLowerBound"`
	IdentityCounterUpperBound int32   `json:"identityCounterUpperBound"`
